...
export class DialogEid24Component {
  ...
  listChatShintaAdha: any[] = [
    ...
    ['Oleh karena itu aku minta maaf', 'sorry'],
    ['Apapun itu semoga kita selalu baik baik saja', 'normal'],
    ['Semoga juga kita bisa hidup bareng-bareng', 'smile'],
    ['Jadi keluarga yang utuh penuh kebahagian untuk kita', 'normal'],
    ['dan demi juga untuk anak anak', 'smile'],
