...
@Component({
  selector: 'app-didik',
  templateUrl: './didik.component.html',
  styleUrls: ['./didik.component.scss']
})
export class DidikComponent {
  name = 'Angular';
  textChat: string = '';
  textChat01: string = '';
  textChat02: string = '';
  ...
  listChat: any[] = [
    ...
    ['Karena saya yakin semua jokes saya sengaja hehe', 'sorry'],
    ['...', 'smile'],
